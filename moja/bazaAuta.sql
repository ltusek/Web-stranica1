...
-- -----------------------------------------------------
-- Table `automobili`.`marke`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `automobili`.`marke` (
...
-- -----------------------------------------------------
-- Table `automobili`.`modeli`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `automobili`.`modeli` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_modeli_marke`
    FOREIGN KEY (`IDmarke`)
    REFERENCES `automobili`.`marke` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = INNODB;
...
-- -----------------------------------------------------
-- Table `automobili`.`vrste`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `automobili`.`vrste` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `automobili`.`auti`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `automobili`.`auti` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_auti_modeli1_idx` (`IDmarke` ASC),
  INDEX `fk_auti_vrste1_idx` (`IDvrste` ASC),
  CONSTRAINT `fk_auti_marke1`
    FOREIGN KEY (`IDmarke`)
    REFERENCES `automobili`.`marke` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_auti_vrste1`
    FOREIGN KEY (`IDvrste`)
    REFERENCES `automobili`.`vrste` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = INNODB;
...
ALTER TABLE vrste CHANGE `naziv` `vrstenaziv` VARCHAR(45);
...
INSERT INTO auti (IDmarke, model, sifra, IDvrste, opis, cijena, slika, arhiviraj) VALUES
(22, 'ESCAPE XLT', 'x1123', 2, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s.', 150000, 'car1.jpg', 1),
(17, 'RAM 1500', 'x002', 8, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s.', 100000, 'car2.jpg', 1),
(22, 'MUSTANG V6', 'x425', 7, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s.', 250000, 'car3.jpg', 1),
(28, 'GENESIS 3.8L', 'x2343', 4, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s.', 150000, 'car4.jpg', 0);
